...
public final class CardTransactionLoggingAspect {
    ...
    @Pointcut("execution(void pl.fullstackdeveloper.payments.AddTransactionUseCase.handle(pl.fullstackdeveloper.payments.CardNumber, pl.fullstackdeveloper.common.model.Money, pl.fullstackdeveloper.payments.TransactionType))")
